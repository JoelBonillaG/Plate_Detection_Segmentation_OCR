...
Salidas (one-shot, se regeneran con --clean):
  ...
  Test_Placas_Ecuador/                                (placas sin label, juez real)
...
SRC = _HERE / "Datasets" / "Modelo_DeteccionPlacasEc.v3i.yolov12"
OUT_TRAIN = _HERE / "Datasets" / "ecuador_real_crops" / "train"
OUT_TEST = _HERE / "Test_Placas_Ecuador"
