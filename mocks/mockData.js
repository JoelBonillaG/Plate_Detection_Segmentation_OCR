...
export const events = [
  // ── Infracción moderada con reincidencia ────────────────────────────────────
  {
    ...
    computerVision: {
      vehicleDetection: {
        label: "Vehiculo",
        confidence: 0.97,
        bbox: "x:184, y:84, w:610, h:342",
      },
      plateDetection: {
        label: "Placa",
        confidence: 0.95,
        bbox: "x:408, y:306, w:132, h:54",
      },
      ...
      activatedRules: [
        {
          id: "R13",
          exceso_set: "moderate",
          reincidencia_set: "moderate",
          severidad_set: "medium_susp",
          activacion: 0.5,
        },
        {
          id: "R12",
          exceso_set: "moderate",
          reincidencia_set: "low",
          severidad_set: "low_susp",
          activacion: 0.5,
        },
      ],
    },
  ...
  // ── Conductor normal (sin infracción) ───────────────────────────────────────
  {
    ...
    vehicle: {
      ...
      model: "Sail",
      color: "Blanco",
      ownerName: "Maria Solis",
      ownerEmail: "m.solis@uni.edu",
    },
    ...
    computerVision: {
      vehicleDetection: {
        label: "Vehiculo",
        confidence: 0.96,
        bbox: "x:198, y:92, w:584, h:330",
      },
      plateDetection: {
        label: "Placa",
        confidence: 0.92,
        bbox: "x:412, y:312, w:126, h:48",
      },
      rectification: "Enderezada a 300×100 px",
  ...
  // ── Advertencia leve (FIS → 0 días) ────────────────────────────────────────
  {
    ...
    computerVision: {
      vehicleDetection: {
        label: "Vehiculo",
        confidence: 0.95,
        bbox: "x:180, y:90, w:600, h:344",
      },
      plateDetection: {
        label: "Placa",
        confidence: 0.9,
        bbox: "x:406, y:309, w:130, h:50",
      },
      rectification: "Enderezada a 300×100 px",
      ...
      activatedRules: [
        {
          id: "R6",
          exceso_set: "minor",
          reincidencia_set: "clean",
          severidad_set: "warning",
          activacion: 0.1667,
        },
        {
          id: "R7",
  ...
  // ── Conducta temeraria (≥ 50 km/h) ─────────────────────────────────────────
  {
    ...
    computerVision: {
      vehicleDetection: {
        label: "Vehiculo",
        confidence: 0.98,
        bbox: "x:175, y:82, w:620, h:350",
      },
      plateDetection: {
        label: "Placa",
        confidence: 0.96,
        bbox: "x:410, y:305, w:138, h:52",
      },
      rectification: "Enderezada a 300×100 px",
...
export const notifications = [
  {
    ...
    eventId: "EVT-00017",
    type: "felicitacion",
    recipient: "m.solis@uni.edu",
    status: "enviado",
    subject: "Conducción responsable en campus",
  },
  {
    id: "NOT-040",
    eventId: "EVT-00018",
    type: "infraccion",
    recipient: "c.andrade@uni.edu",
    status: "pendiente",
    subject: "Revisión pendiente por exceso de velocidad",
  },
  {
    id: "NOT-039",
    eventId: "EVT-00015",
    type: "infraccion",
    recipient: "a.mora@uni.edu",
    status: "pendiente",
    subject: "Conducta temeraria — revocación de acceso",
  },
];
