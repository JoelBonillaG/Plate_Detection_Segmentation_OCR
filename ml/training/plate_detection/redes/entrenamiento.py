...
# guardar el modelo y resultados en ml/models/plate_detection/runs/
MODELOS_DIR = PROJECT_ROOT / "models" / "plate_detection" / "runs"
...
def entrenar():
    ...
    modelo.train(
        ...
        project=str(MODELOS_DIR),  # guardar en ml/models/plate_detection/runs/
        name="placas_scratch",
