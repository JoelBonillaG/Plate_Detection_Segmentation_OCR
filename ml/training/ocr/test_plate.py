...
if __name__ == "__main__":
    ...
    project_root = _here.resolve().parents[2]
    parser.add_argument("--image", default=str(_here / "placa.png"))
    parser.add_argument("--model", default=str(project_root / "models" / "ocr" / "Modelos" / "best_cnn_ocr.keras"))
    parser.add_argument("--classes", default=str(project_root / "models" / "ocr" / "Modelos" / "classes.txt"))
