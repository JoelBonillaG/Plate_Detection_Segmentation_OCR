...
_RAW_DATASETS = PROJECT_ROOT / "datasets" / "raw"
DATASET_UK = _RAW_DATASETS / "uk_plates"
DATASET_BR = _RAW_DATASETS / "brazil_plates"
...
def main():
    output_dir = OUTPUT_DIR
    prepare_output_dirs(output_dir, clean=CLEAN_OUTPUT)

    all_results = {}

    print("\n=== Procesando UK ===")
    uk_results = process_dataset(
        dataset_dir=DATASET_UK,
        output_dir=output_dir,
        output_size=OUTPUT_SIZE,
        padding_ratio=PADDING_RATIO,
        log_every=LOG_EVERY,
